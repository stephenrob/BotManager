...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "http://bitbucket.org"
    spec.metadata["changelog_uri"] = "http://bitbucket.org"
  else
